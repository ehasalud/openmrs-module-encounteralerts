 ...
 */
@Controller
@RequestMapping("/module/encounteralerts/encounterAlertList")
public class  EncounterAlertsListController {
	...
	protected String processSubmit(HttpServletRequest request) {
		...
		for (String s : toDelete) {
			...
			service.deleteEncounterAlert(service.getEncounterAlert(id));
		}
